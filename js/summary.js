...
function initSummary() {
    ...
    sum_frame_squares.innerHTML = /*html*/ `
        ...
        <!-- <div class="chat_gpt">
            <input type="text" id="prompt" name="prompt" placeholder="Ask me" onclick="showScreen()">
            <button type="button" id="submit_btn" onclick="getMessage()">
                <img id="sum_done_img" src="./img/send.png" alt="Send">
            </button>  
        </div>
        <div class="chat_gpt_answer" id="chat_gpt_answer">
            <span id="output" name="output"></span>
            <img class="loading_gif" id="loading_gif" src="./img/loading.gif" alt="Loading">
            <img class="hide_chat_gpt_answer_btn" src="./img/cancel.png" onclick="hideScreen()"> 
        </div> -->
    `;
    getTime();
    countUrgent();
